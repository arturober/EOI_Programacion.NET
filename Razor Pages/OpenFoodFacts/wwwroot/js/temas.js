...
const claveTema = "tema-open-food-facts";
...
function aplicarTema(tema) {
    ...
    // Los componentes necesitan saber si el fondo general es claro u oscuro.
    document.documentElement.setAttribute(
        "data-bs-theme",
        temasOscuros.includes(tema) ? "dark" : "light");
}

// Recupera la elección anterior del usuario o utiliza Bootstrap claro.
const temaGuardado = localStorage.getItem(claveTema) ?? "bootstrap-light";
